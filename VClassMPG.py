#Python file creates boxplots that compare MPG by vehicle class
...
query_string = """SELECT (city08+highway08)/2
                FROM vehicle 
...
ax.set_xlabel('Combined City and Highway MPG')
label = ['Vans', 'Trucks', 'SUVs', 'Sedans', 'Compact Cars']
ax.set_yticklabels(label)
ax.set_title('Fuel economy in MPG by Vehicle Class')
